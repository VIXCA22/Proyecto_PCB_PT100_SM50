...
\item Se conservó la resistencia en serie de \(\SI{180}{\ohm}\), ya que corresponde a la versión del acondicionamiento con salida aproximada de \(\SIrange{0}{5}{V}\) para el SM-50.
...
\textbf{Resultados:}
Se actualizaron los valores finales del diseño: SM-50 con \(R_G=\SI{340}{\ohm}\), formado por \(\SI{160}{\ohm}+\SI{180}{\ohm}\), salida aproximada de \(\SIrange{0}{5}{V}\); y PT100 con \(I_{exc}=\SI{0.5}{mA}\) y \(R_G=\SI{1}{k\ohm}\).
...
\item Se incorporaron los valores actuales del canal SM-50: excitación de puente de \(\SI{10}{V}\), sensibilidad nominal de \(\SI{3}{mV/V}\), salida diferencial cruda de \(\SI{30}{mV}\), \(R_G=\SI{340}{\ohm}\) mediante \(\SI{160}{\ohm}+\SI{180}{\ohm}\), y salida aproximada \(\SIrange{0}{5}{V}\).
